...
vim.keymap.set("n", "<leader>lp", ":LivePreview start", { desc = "Live preview of html" })
vim.keymap.set("n", "<leader>lpc", ":LivePreview start", { desc = "Close the Live preview of html" })
